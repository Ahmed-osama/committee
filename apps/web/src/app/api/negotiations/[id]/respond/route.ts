...
export async function POST(
  ...
  const counterPriceEgp =
    typeof body?.counterPriceEgp === 'string'
      ? Number(body.counterPriceEgp)
      : (body?.counterPriceEgp as number | undefined);
  ...
  try {
    ...
    if (
      ...
      error instanceof NegotiationNotOpenError ||
      error instanceof InvalidCounterPriceError
    ) {
